...
public class KampusApp {
    ...
    public void menuTambah() {
        ...
        Mahasiswa mahasiswa = new Mahasiswa(nim, nama, nama);
        db.mahasiswaTbl.create(mahasiswa, nama);
    ...
    public void menuUbah() {
        ...
        System.out.print("Masukan Nama: ");
        String nama = scanner.nextLine();
        Mahasiswa mahasiswa = new Mahasiswa(nimBaru, nama, nama);
        db.mahasiswaTbl.update(nimLama, mahasiswa, nama);
        System.out.println("Tekan Enter untuk melanjutkan...");
        scanner.nextLine();
        showMenu();
    }
